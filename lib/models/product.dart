import 'package:yuka_clone/models/nutriments.dart';
import 'package:yuka_clone/models/nutriscore.dart';
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      ...
      nutriscore:
          Nutriscore.fromJson(json['nutriscore'] as Map<String, dynamic>),
